 ...
 * the Gap Remediation Phase 10 F4 float-codegen notes — the arithmetic
 * ops under T_F32/T_F64 are REAL (the F/D GP-bounce in emit_instr);
 * only float MOD and FLAG_IMM forms reject). Keeping the
