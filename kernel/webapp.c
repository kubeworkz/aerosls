...
static const char BUILTIN_INDEX[] =
    ...
    "agent create n ep mdl   Create AI agent\n"
    "agent run n msg         Run ReAct inference loop\n"
    "agent list              Show all agents\n"
    "workflow create n t s   Define s-step pipeline\n"
    "workflow addstep n a i o  Append pipeline step\n"
    "workflow run n input    Execute pipeline"
    "</pre>"
