 ...
 * AeroSLS-SIMI-ISA-v0.1.md §12 for why this is weaker evidence than
 ...
 * no real RV64 CPU underneath it." simi_riscv.c's RESOLVE/OBJSIZE/OBJTYPE
 ...
 * simi_riscv.h), exactly like x86's movabs+call. On real hardware (or in
 ...
 * simi_riscv_translate() as if they were real function addresses; the
 ...
 * OBJSIZE's argument) rather than by review. See AeroSLS-SIMI-ISA-v0.1.md
...
/* Address to hand to simi_riscv_translate() as rt_resolve_fn/rt_objsize_fn/
