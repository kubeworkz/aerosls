 ...
 * the simi-jit-test harness) and under a freestanding x86_64 kernel build
 * (kernel/simi_translate.c wraps this with kernel-specific buffer/mapping
 * calls). See AeroSLS-SIMI-ISA-v0.1.md §7 Phase 3 and §9 for the design.
 *
 ...
 *     pointer to a small legitimately-mapped scratch buffer. SIMI has no
 ...
 *     as namepool_ptr — a pointer straight into the SIMI object's own raw
 ...
 *     to simi_rt_resolve/simi_rt_objsize/simi_rt_objtype, whose addresses
