 ...
 * which this test does not link (see the stub block's header above); the
 * pairing itself is covered against the real pool by
 * tests/syscall_stack_pair_host_test.c. Inert here — this test never spawns. */
