...
//! `sls-kerneld` (arena + cap refcounts + channel queues over TCP),
//! `wasm-sidecar` (a wasmi embedding driving the generated client), and the
//! `lisp_sidecar.lisp` (a real SBCL process running the generated dispatch).
