...
//! (ramdisk implementation plan §3.2 step 2 — the same contract this driver
//! follows) initializes the heap, so it exists and is unit-tested. It is
//! intentionally *not* wired as the Rust global allocator — nothing in the
//! driver allocates.
